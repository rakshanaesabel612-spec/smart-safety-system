...
async function sendSosWhatsapp(recipients: string[], message: string): Promise<{ deliveredCount: number; diagnostics: string[] }> {
...
async function sendSosEmail(recipients: string[], subject: string, message: string): Promise<{ deliveredCount: number; diagnostics: string[] }> {
  const diagnostics: string[] = [];
...
export async function processSosAlert(input: SosMessageInput): Promise<SosResult> {
